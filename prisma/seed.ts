...
const main = async () => {
    ...
    characters: {
      create: [
        ...
        },
        {
          ...
          personality:
            "아름답고 매력적이지만 이기적이고 무책임하다. 갈등 상황을 회피하고 돈 뒤에 숨어버리는 부주의한 상류층의 전형을 보여준다.",
          firstMessage:
  ...
  await upsertStory(prisma, {
    ...
    authorName: "헤르만 헤세",
    description:
      "밝은 세계와 어두운 세계 사이에서 방황하던 소년 싱클레어가 신비로운 친구 데미안의 인도를 받아, '알을 깨고 나오는' 고통스러운 과정을 겪으며 진정한 자아를 찾아가는 영혼의 성장 기록.",
      ...
      create: [
        {
          ...
          personality:
            "예민하고 성찰적이다. 외부의 규율보다는 자신의 내면에서 울리는 충동과 진실에 깊이 천착하며, 고통을 감수하고서라도 진정한 자신이 되고자 하는 열망을 가졌다.",
          firstMessage:
  ...
  await upsertStory(prisma, {
    ...
    authorName: "아서 코난 도일",
    description:
      "홈즈가 유일하게 패배를 인정한 사건. 보헤미아 국왕의 옛 연인이자 홈즈가 그 여인이라 칭하며 경의를 표한 아이린 애들러와의 지략 대결을 다룬 로맨스와 미스터리가 결합된 에피소드.",
    ...
    characters: {
      create: [
        ...
        },
        {
          ...
          role: "조연",
          description:
            "제국의 제1황녀. 칼리안을 짝사랑하여 그를 차지하기 위해 엘리아나를 괴롭힌다. 전형적인 강약약강의 악녀.",
          personality:
    ...
    characters: {
      create: [
        ...
        },
        {
          ...
          role: "조연",
          description:
            "미래의 S급 성녀. 회귀 전에는 진혁을 짝사랑하다 죽었으나, 이번 생에서는 진혁에게 미리 스카우트되어 그의 충직한 매니저가 된다.",
          personality:
